...
function monkeyWish(ef) {
  (0, import_kolmafia5.visitUrl)("choice.php?whichchoice=1501&pwd=".concat((0, import_kolmafia5.myHash)(), "&wish=").concat(ef, "&option=1"));
}
...
function main() {
  monkeyWish($effect(_templateObject120 || (_templateObject120 = _taggedTemplateLiteral15(["Joy"])))), (0, import_kolmafia17.abort)(), clearBCProperties(), _set("customCombatScript", "burrows_hccs"), (0, import_kolmafia17.visitUrl)("council.php"), (0, import_kolmafia17.itemAmount)($item(_templateObject228 || (_templateObject228 = _taggedTemplateLiteral15(["diabolic pizza cube"])))) && (0, import_kolmafia17.use)($item(_templateObject320 || (_templateObject320 = _taggedTemplateLiteral15(["diabolic pizza cube"])))), testDone(TEST_COIL_WIRE) || doTestCoilWire(), testDone(TEST_MYS) || doTestMys(), testDone(TEST_HP) || doTestHp(), testDone(TEST_MUS) || doTestMus(), testDone(TEST_MOX) || doTestMox(), testDone(TEST_ITEM) || doTestItem(), testDone(TEST_HOT_RES) || doTestHotRes(), testDone(TEST_NONCOMBAT) || doTestNoncombat(), testDone(TEST_FAMILIAR) || doTestFamiliar(), testDone(TEST_WEAPON) || doTestWeapon(), testDone(TEST_SPELL) || doTestSpell(), doTest(30), (0, import_kolmafia17.cliExecute)("ccs aftercore_combat"), (0, import_kolmafia17.cliExecute)("hagnk all");
}
